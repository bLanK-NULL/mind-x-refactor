...
describe('graph rules', () => {
  ...
  it('rejects an edge with a dangling source', () => {
    ...
    doc.nodes.push({ id: 'child', type: 'topic', position: { x: 240, y: 0 }, data: { title: 'Child' } })
    doc.edges.push({ id: 'edge-1', source: 'missing', target: 'child', type: 'mind-parent' })
  ...
  it('rejects an edge with a dangling target', () => {
    ...
    doc.edges.push({ id: 'edge-1', source: 'root', target: 'missing', type: 'mind-parent' })
  ...
  it('rejects a node as its own parent', () => {
    ...
    doc.nodes.push({ id: 'a', type: 'topic', position: { x: 0, y: 0 }, data: { title: 'A' } })
    doc.edges.push({ id: 'edge-1', source: 'a', target: 'a', type: 'mind-parent' })
  ...
  it('rejects cycles', () => {
    ...
    doc.nodes.push(
      { id: 'a', type: 'topic', position: { x: 0, y: 0 }, data: { title: 'A' } },
      { id: 'b', type: 'topic', position: { x: 240, y: 0 }, data: { title: 'B' } }
    )
    doc.edges.push(
      { id: 'edge-1', source: 'a', target: 'b', type: 'mind-parent' },
      { id: 'edge-2', source: 'b', target: 'a', type: 'mind-parent' }
    )
